...
<pre>
<code><span class="pl-k">var</span> str <span class="pl-k">=</span> <span class="pl-s">"""
Hello /
Hello
Hello Again
"""
</span>
<span class="pl-c1">print</span>(str)</code>
</pre>
...
Here we used the reduce method to multiply a sequence of numbers from 1 to 5. We used a closure that accepts two integers and multiply the “accumulator” and the “newValue” together, starting with an accumulator of 1. Notice that the closure signature is the same as the multiply operation (_), which means we can use it directly as a closure to achieve the same result.
let factorial = (1...5).reduce(1, _)
